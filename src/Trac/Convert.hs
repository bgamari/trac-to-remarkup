...
convertBlock n cm (R.List R.BulletListType bs) =
  List BulletStyle <$> mapM (convertBlocks n cm) bs
convertBlock n cm (R.List R.NumberedListType bs) =
  List NumberedStyle <$> mapM (convertBlocks n cm) bs
